  ...
  return (
    <section className="min-h-screen flex items-center justify-center pt-20 px-4 relative overflow-hidden">
      ...
      <div 
        ...
        style={{
          backgroundImage: `
            linear-gradient(to right, rgba(124, 69, 133, 0.1) 1px, transparent 1px),
      ...
      <div className="absolute bottom-20 right-10 w-72 h-72 bg-secondary/20 rounded-full blur-3xl opacity-50 animate-pulse"></div>
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        <p
          className={`text-lg sm:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto transition-all duration-1000 delay-200 ${
            isVisible ? "animate-fade-in-up" : "opacity-0 translate-y-10"
          }`}
        >
        ...
        >
          <button
            ...
            className="px-8 py-3 rounded-lg bg-gradient-to-r from-primary to-secondary hover:from-secondary hover:to-accent text-white font-semibold transition-all duration-300 hover:shadow-lg hover:shadow-primary/50 hover:scale-105"
          >
            Explore Courses
          </button>
          <button
            ...
            className="px-8 py-3 rounded-lg border border-primary text-primary hover:bg-primary/10 font-semibold transition-all duration-300 hover:scale-105"
          >
            Meet Our Experts
          </button>
        </div>
